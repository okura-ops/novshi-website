...
export const RESALE: ResaleProperty[] = [
  ...
  },
  {
    ...
    "area": "その他（宮若）",
    "address": "宮若市宮田",
    "layout": "4K（平屋2棟を連結。キッチン2・浴室2・玄関2）",
    "structure": "木造平屋",
    "bldgArea": "73.78㎡",
    "landArea": "228.98㎡（約69坪）",
    "built": "1957年（昭和32年）・築69年",
    "access": "スーパーセンタートライアル宮田店まで車4分・1.9km／JR筑豊本線 直方駅まで車19分・10.1km（宮若市内に鉄道駅はなく車移動が前提）",
    "infra": [
      "上水道：公営",
      "トイレ：汲取式",
      "ガス：プロパン"
    ...
    "tenantProfile": "個人（3人世帯）",
    "leaseType": "普通建物賃貸借（定期借家ではありません）",
    "leaseTerm": "2026年9月1日〜2028年8月31日（2年）。更新料0円で2年ごとに自動更新します",
    "deposit": "敷金0円・礼金0円・更新料0円",
    "guarantor": "日本セーフティー株式会社",
    "parking": "カーポート1台分（賃料に含みます）",
    "lead": "平屋2棟を連結した造りで、キッチン・浴室・玄関が2つずつあります。土地約69坪。現況のままお貸しし、掲載から20日で入居者が決まりました。",
    "highlights": [
      "キッチン・浴室・玄関が2系統。ルームシェアや二世帯の使い方ができます",
      "土地228.98㎡（約69坪）。駐車と庭に余裕があります",
      "掲載から20日で入居者が決まった（2026年8月2日掲載・8月22日成約）"
    ],
    "disclosures": [
      "築69年の建物です。現況のままお引き渡ししています",
      "トイレは汲取式です",
      "ガスはプロパンです"
    ],
    "maps": {
      "wide": "福岡市と北九州市の間、宮若市です（中心が本物件）",
      "area": "周辺は住宅地です。市内に鉄道駅はなく車移動が前提になります"
    },
    "occupancyRecord": [
      {
        "label": "募集から成約まで",
        "value": "20日（2026年8月2日に募集を開始し、8月22日に賃貸借契約を締結しました）"
      },
      {
        "label": "入居開始",
        "value": "2026年9月1日"
      ...
      {
        "label": "工事",
        "value": "改修は行わず、現況のままお貸ししています"
      }
    ],
    "neighborhood": [
      {
        "label": "敷地の余裕",
        "value": "土地228.98㎡（約69坪）に対し建物73.78㎡"
      },
      {
        "label": "生活施設",
        "value": "スーパーセンタートライアル宮田店（24時間営業）まで車4分・1.9km"
      },
      {
        "label": "交通",
        "value": "JR筑豊本線 直方駅まで車19分・10.1km。宮若市内に鉄道駅はなく車移動が前提です"
      }
    ],
    "siteNote": "所要時間はGoogleマップで本物件の座標から実測した車での所要時間です（2026年8月16日取得）。学校・医療は未調査です。",
    "guarantorScope": "集金代行型。保証料は借主負担（初回20,000円・月額800円）で、引落しは毎月27日です。連帯保証人は立てず、緊急連絡先1名を届け出ています",
    "rentStart": "2026年10月1日（初月1か月分はフリーレントのため賃料が発生しません）"
  },
  {
    "code": "006",
    "slug": "006-ikisu",
    ...
    "leaseTerm": "2026年9月1日〜2028年8月31日（2年）。更新料0円で2年ごとに自動更新します",
    "deposit": "敷金0円・礼金0円・更新料0円",
    "guarantor": "株式会社グローバルトラストネットワークス（TrustNet21）",
    "maps": {
    ...
    "occupancyRecord": [
      ...
      {
        "label": "契約",
        "value": "2026年8月31日に締結。契約開始は9月1日です"
      },
      {
        "label": "賃料の発生",
        "value": "2026年10月1日から（初月はフリーレント）"
      }
    ],
    "neighborhood": [
      {
    ...
    "guarantorScope": "保証プラン「集金代行型 RP PLUS50」。保証料は借主負担（初回31,500円・月額1,000円）です。連帯保証人は立てていません",
    "rentStart": "2026年10月1日（初月1か月分はフリーレントのため賃料が発生しません）"
  },
  {
    "code": "007",
  ...
  },
  {
    ...
    "parking": "カーポート付き",
    "infra": [
      "トイレ：洋式（手洗付ロータンク）。汚水は汲み取り式で、汲み取りの手配と費用は借主負担です",
      "浴室：大理石調の浴槽・玉石の洗い場",
      "給湯：建物脇に給湯機。ガスはプロパン（寿ガス株式会社）",
      "台所コンロ・エアコン・照明器具は設置されていません（借主が用意します）"
    ],
    ...
    "disclosures": [
      "賃料45,000円の内訳は建物40,000円＋駐車場5,000円です。駐車場は2026年11月1日から本物件に含みます",
      "トイレは洋式ですが汚水は汲み取り式です。内装は建築当時のままです",
      "台所は床の仕上げが一部剥がれ、天井の換気扇まわりが破損しています。コンロは設置されていません",
      "エアコンと照明器具は設置されていません",
      "築48年の建物です"
    ],
    "leaseStart": "2026年11月",
    ...
    "tenantProfile": "個人",
    "leaseType": "普通建物賃貸借（定期借家ではありません）",
    "leaseTerm": "2026年11月1日〜2028年10月31日（2年）。更新料0円で2年ごとに自動更新します",
    "deposit": "敷金0円・礼金0円・更新料0円",
    "guarantor": "日本セーフティー株式会社",
    "maps": {
    ...
    "siteNote": "所要時間はGoogleマップで本物件の座標から実測した車での所要時間です（2026年9月10日取得）。学校・医療は未調査です。",
    "guarantorScope": "保証プラン「パートナー（連帯保証人なし）」。保証対象額は賃料45,000円全額です。保証料は借主負担（初回22,500円・月額800円）で、保証開始は2026年11月1日です",
    "rentStart": "駐車場部分5,000円は2026年11月1日から、建物部分40,000円は2026年12月1日から（建物部分は初月フリーレント）。全額45,000円の発生は2026年12月1日からです"
  },
  {
    "code": "015a",
    ...
    "photos": [
      {
        "file": "01",
        "alt": "母屋の外観（南側。高台で見晴らしがあります）"
      },
      {
        "file": "02",
        "alt": "母屋の和室（続き間・床の間と障子）"
      },
      {
        "file": "03",
        "alt": "母屋の台所（ガスコンロ・レンジフード）"
      },
      {
        "file": "04",
