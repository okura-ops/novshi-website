...
export const RESALE: ResaleProperty[] = [
  ...
  },
  {
    ...
    "lead": "1,204.59㎡（約364坪）の敷地に3棟が建つうちの母屋です。平屋101.17㎡で、駐車は1台込み・最大3台まで対応できます。",
    "highlights": [
      "平屋101.17㎡。この賃料帯では大きい",
      "小倉と黒崎の中間で、北九州市内の通勤先を広く取れます"
    ],
    "disclosures": [
      "母屋は2026年9月6日に入居申込をいただき、保証会社の審査中です。賃貸借契約はまだ締結していません",
    ...
    "occupancyRecord": [
      ...
      {
        "label": "申込",
        "value": "2026年9月6日に申込をいただき、保証会社の審査中です（募集開始から6日）"
      },
      {
        "label": "入居予定",
        "value": "2026年9月20日"
  ...
  },
  {
    ...
    "lead": "約364坪の敷地に母屋・駐車場棟（上階は2室のアパート）・貸戸建の3棟が建ちます。貸戸建と駐車場2区画は現に賃料が入っており、母屋は申込をいただいた段階です。",
    "highlights": [
      "1,204.59㎡（約364坪）の敷地に3棟。1棟あたりの単価が下がります",
      "貸戸建と駐車場2区画は入金の実績があり、賃料の一部が既に立っています",
      "母屋が契約に至れば月8.5万円になります"
    ],
    "disclosures": [
      "母屋は2026年9月6日に入居申込をいただき、保証会社の審査中です。賃貸借契約はまだ締結していません",
      "母屋の登記は家屋番号1003番4の2（消去法で特定。登記事項証明書で確定させます）",
      ...
      "賃料8.5万円のうち3.0万円は入金実績のある実績値、5.5万円は母屋の募集賃料（想定）です"
    ],
    "maps": {
      "wide": "北九州市八幡東区。小倉と黒崎の中間に位置します（中心が本物件）",
      "area": "周辺は住宅地です"
    ...
    "occupancyRecord": [
      ...
      {
        "label": "母屋",
        "value": "2026年8月31日に募集を開始し、9月6日に申込をいただきました（6日）"
      }
    ],
    "neighborhood": [
      {
