...
export const PROPOSALS: ProposalData[] = [
  {
    ...
    recipient: {
      ...
      rentBudget: '家賃5万円ほど',
      context:
        '以前ご覧になりたいとおっしゃっていた家は、申込が入ってしまいました。同じ条件で探し直して、飯塚市内の平屋を2軒見つけたのでお持ちしました。',
    },
    lead:
      'どちらも売りに出ている家です。ご希望に合いそうなら、当社が買って、貸主としてお貸しする形になります。買いにいく前にお見せしているので、方向が合っているかどうかを教えてください。違えば、そのまま探し直します。',
    requiredNotices: [
      'どちらもまだ当社の持ち物ではありません。ご希望に合いそうだと分かってから、買いにいきます。',
    ...
    properties: [
      ...
      },
      {
        ...
        // この幅の根拠（[[feedback_rent_floor_irr_check]]）：
        //   掲載価格のまま買うと表面20%の下限は5.81万（基本工事100万）／6.64万（同150万）。
        //   5.5万は45万の指値＋基本工事100万が通った場合の数字で、工事が150万に伸びると
        //   下限が幅の上を超える。指値が入らないなら幅を6.0〜6.6万へ引き上げること。
        rent: {
          min: 55000,
          max: 60000,
    ...
    questions: [
      'この2軒は、お探しの条件に合っていますか。条件そのものが変わっていれば、いまのご希望（エリア・部屋数・駐車の台数・ご予算など）を教えてください',
      '気になるほうがあれば、どちらか教えてください（「どちらも違う」でも構いません）',
      '条件は合っているのに気が進まない、というところがあれば教えてください。次にお持ちする家が変わります',
